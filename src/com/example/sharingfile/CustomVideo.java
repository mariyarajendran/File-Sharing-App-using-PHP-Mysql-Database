...
public class CustomVideo extends ArrayAdapter<String>{
	  ...
	  private String[] idd;
	   ...
	   Context context2;
	    ...
	    public CustomVideo(Activity context, String[] urls,String[] idd) {
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	       ...
	       // getResizedBitmap(bitmaps[position], 100, 100);
            ...
            .load((urls[position]))
             ...
             .placeholder(R.drawable.videoplace) // can also be a drawable
